                      ...
                      <div className="col-70">
                        <div className="blog__details-wrap">
                          ...
                          <div className="blog__details-content">
                            ...
                            <p>
                              when an unknown printer took ar galley offer type
                              year anddey scrambled make type aewer specimen
                              book bethas survived not only five when annery
                              unknown printer.eed a little help from our friends
                              from time to time. Although we offer the one-stop
                              convenience.
                            </p>
                            <p>
                              ...
                              services under one roof.eed a little help from our
                              friends from time to time. Although we offer the
                              one-stop convenience.
                            </p>
                            <blockquote>
                              <p>
                                “ urabitur varius eros rutrum consequat Mauris
                                aewa sollicitudin enim condimentum luctus enim
                                justo non molestie nisl ”
                              </p>
                            </blockquote>
                            ...
                            <p>
                              ...
                              unchan galley of type and scrambled it to make a
                              type specimen book.
                            </p>
                              ...
                              <div className="row align-items-center">
                                ...
                                <div className="col-54">
                                  <div className="blog__details-inner-content">
                                    <h4 className="title">
                                      Conduct replied off whether arrived
                                      adapted
                                    </h4>
                                    <p>
                                      when an unknown printer took a galley type
                                      remaining essentially unchan galley of
                          ...
                          <div className="blog__avatar-wrap mb-60">
                            ...
                            <div className="blog__avatar-info">
                              ...
                              <p>
                                ...
                                choose dentace ducts because kn ow we are the
                                    ...
                                    <li>
                                      <div className="comments-box">
                                        ...
                                        <div className="comments-text">
                                          ...
                                          <p>
                                            Finanappreciate your trust greatly
                                            Our clients choose dentace ducts
                                            because know we are the best area
                                            Awaitingare really.
                                          </p>
                                          <Link href="#" className="reply-btn">
                                            Reply
