...
export default function Header4({
  ...
  return (
    <>
      <header className="tg-header__style-four transparent-header">
              ...
              <div className="col-lg-8">
                <ul className="tg-header__top-info tg-header__top-info-three list-wrap">
                  <li>
                    ...
                    <Link href="tel:0918638068">
                      0918 638 068 - 02633 575 579
                    </Link>
                  </li>
                  <li>
                    <i className="flaticon-pin" />
                    10 Phạm Hồng Thái, phường 10, thành phố Đà Lạt, Lâm Đồng
                  </li>
                </ul>
              </div>
                ...
                <div className="tgmobile__menu">
                  <nav className="tgmobile__menu-box">
                    ...
                    <div className="nav-logo">
                      <Link href="/">
                        <img src="logo.jpg" alt="Thuê xe ô tô đà lạt" />
                      </Link>
                    </div>
